...
<head>
    ...
    <link rel="stylesheet"
        href="<?= base_url() ?>assets/template-admin/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet"
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        ...
                        <div class="d-flex m-3 me-0">
                            <a href="#" data-bs-toggle="modal" data-bs-target="#shoppingCartModal"
                                ...
                                <span
                                    class="position-absolute bg-secondary rounded-circle d-flex align-items-center justify-content-center text-white px-2"
                                    style="top: -5px; right: -10px; height: 20px; min-width: 20px;"
                                    id="cartItemCount"></span>
                            </a>
                            <div class="dropdown">
                                <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown">
                                    <img src="<?= base_url() ?>assets/image/user/<?= $user['image'] ?>" alt="User Profile"
