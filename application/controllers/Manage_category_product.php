...
class Manage_category_product extends CI_Controller
{
    var $module_js = ['manage-category-product'];
    var $app_data = [];
    ...
    public function index()
    {
        ...
        $this->load->view('menu-admin/manage_category_product');
    ...
    public function get_data()
    {
        ...
        $result = $this->data->find('kategori_produk', $where)->result();
    ...
    {
        $this->form_validation->set_rules('nama', 'Nama', 'required|trim|is_unique[kategori_produk.name]');
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->data->insert('kategori_produk', $data);
    ...
    public function edit_data()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $where = array('id' => $id);
            $this->data->update('kategori_produk', $where, $data);
    ...
    public function delete_data()
    {
        ...
        $updated = $this->data->update('kategori_produk', $where, $data);
        if ($updated) {
            $response['success'] = "<script>$(document).ready(function () {
                var Toast = Swal.mixin({
                    toast: true,
