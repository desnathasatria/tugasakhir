...
MySQL - 10.4.28-MariaDB : Database - gtt
*********************************************************************
*/
...
CREATE TABLE `administration` (
  ...
  CONSTRAINT `administration_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `st_user` (`id`),
  CONSTRAINT `administration_ibfk_2` FOREIGN KEY (`id_letter`) REFERENCES `letter` (`id`)
...
insert  into `company_profile`(`id_company`,`company_name`,`address`,`phone_number`,`email`,`embed_address`,`company_logo`,`logo_footer`,`created_date`,`created_by`,`updated_date`,`updated_by`,`deleted_date`,`deleted_by`,`is_deleted`) values 
(1,'GTT','Jl. Pamenang No.1, Besok, Toyoresmi, Kec. Ngasem, Kabupaten Kediri','085233175312','Gttkediri@yahoo.co.id','https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15811.474021979933!2d111.9880199!3d-7.8037427!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e785a02bd6effb7%3A0xf175d81d9ce79ff6!2sGtt%20Pusat%20Oleh%20Oleh!5e0!3m2!1sen!2sid!4v1715326784423!5m2!1sen!2sid','company_2024-05-01_07-27-43.png',NULL,'2023-08-09 08:52:27',NULL,'2024-05-10 14:40:29',1,NULL,NULL,0);
...
CREATE TABLE `reply_message` (
  ...
  CONSTRAINT `reply_message_ibfk_1` FOREIGN KEY (`id_message`) REFERENCES `message_user` (`id`)
...
CREATE TABLE `st_user` (
  ...
  CONSTRAINT `st_user_ibfk_1` FOREIGN KEY (`id_credential`) REFERENCES `app_credential` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=67 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `st_user` */

insert  into `st_user`(`id`,`id_credential`,`name`,`email`,`phone_number`,`address`,`image`,`username`,`password`,`last_login`,`created_date`,`created_by`,`updated_date`,`updated_by`,`deleted_date`,`deleted_by`,`is_deleted`) values 
(1,2,'Desnatha Satria','satriadesnatha@gmail.com','082245146996','JL Tirtoudan Raya','superadmin-2024-06-12_14-13-45.jpg','superadmin','ef797c8118f02dfb649607dd5d3f8c7623048c9c063d532cc95c5ed7a898a64f','2024-06-14 14:03:00','2023-10-27 09:10:26',NULL,'2024-06-12 19:13:45',1,NULL,NULL,0),
(53,3,'Tegar Darmawan','tegardarmawan@gmail.com','08167525332','Jalan Diponegoro 86, Kota Batu Batu Jawa Timur Indonesia','tegar_-_2023-11-22_17-28-43.jpg','tegar','ef797c8118f02dfb649607dd5d3f8c7623048c9c063d532cc95c5ed7a898a64f','2023-11-23 07:39:33','2023-11-18 13:58:19',NULL,'2023-11-23 04:31:55',1,'2024-03-22 14:15:46',1,1),
(57,3,'Lando','DesnathaLand99@gmail.com','08253647322','desa tosaren','lando_-_2023-11-23_01-51-29.jpg','lando','ef797c8118f02dfb649607dd5d3f8c7623048c9c063d532cc95c5ed7a898a64f','2023-11-23 07:53:09','2023-11-23 07:50:29',NULL,'2023-11-23 07:51:29',57,'2024-03-09 11:05:48',1,1),
(58,3,'Desnatha','desnatha@gmail.com','345345345','wad','desnathas_-_2024-06-12_14-13-55.png','desnathas','eb045d78d273107348b0300c01d29b7552d622abbc6faf81b3ec55359aa9950c','2024-06-11 11:24:30','2023-11-24 07:57:48',NULL,'2024-06-12 19:13:55',58,'2024-03-09 11:05:41',1,1),
(59,2,'Lintang Windy Pratama','lintang@gmail.com','08118393847','Jl Griyo udan tirto permai','lintangsuper-2024-03-18_02-09-30.jpg','lintangsuper','ef797c8118f02dfb649607dd5d3f8c7623048c9c063d532cc95c5ed7a898a64f',NULL,'2024-03-18 08:09:30',1,NULL,NULL,'2024-03-18 08:23:44',1,1),
(60,3,'Tegar Darmawan','tegar@gmail.com','082283922292','Jl Griyo udan tirto permai','tegardarma-2024-03-18_02-12-02.jpg','tegardarma','ef797c8118f02dfb649607dd5d3f8c7623048c9c063d532cc95c5ed7a898a64f',NULL,'2024-03-18 08:12:02',1,NULL,NULL,'2024-03-18 08:23:42',1,1),
(63,1,'Frankie','frankie@gmail.com','08883866931','Jl Griyo udan tirto permai','@frank31-2024-03-18_04-57-38.jpg','@frank31','ef797c8118f02dfb649607dd5d3f8c7623048c9c063d532cc95c5ed7a898a64f',NULL,'2024-03-18 10:57:38',1,'2024-03-18 10:58:25',1,'2024-03-22 08:16:52',1,1),
(64,1,'Jihan Cahya Firmana','lisulare@gmail.com','082245146996','Kediri','jihan-2024-04-01_06-21-04.jpg','jihan','ef797c8118f02dfb649607dd5d3f8c7623048c9c063d532cc95c5ed7a898a64f',NULL,'2024-04-01 11:21:04',1,NULL,NULL,'2024-04-02 08:59:01',1,1),
(65,3,'Desnatha','desnatha@gmail.com','082245146996','Kediri','lando123-2024-06-12_14-18-49.jpeg','lando123','ef797c8118f02dfb649607dd5d3f8c7623048c9c063d532cc95c5ed7a898a64f',NULL,'2024-05-12 13:53:05',NULL,'2024-06-12 19:18:49',1,'2024-06-12 19:20:59',1,1),
(66,3,'Desnatha Satria Lando Arisukma','desnathaas99@gmail.com','082245146996','Jl Tirtoudan Raya','lando1234_-_2024-06-12_14-22-00.png','lando1234','ef797c8118f02dfb649607dd5d3f8c7623048c9c063d532cc95c5ed7a898a64f',NULL,'2024-06-12 19:21:29',NULL,'2024-06-12 19:22:00',66,NULL,NULL,0);
...
CREATE TABLE `supplier` (
  ...
  CONSTRAINT `supplier_ibfk_1` FOREIGN KEY (`id_produk`) REFERENCES `produk` (`id`)
